    ...
    return GetBuilder<RideController>(builder: (rideController){
      return GetBuilder<LocationController>(builder: (locationController){
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(
            rideController.currentRideState == RideState.acceptingRider ? 'rider_is_coming'.tr : 'trip_is_ongoing'.tr,
            style: textSemiBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall),
          ),
          const SizedBox(height: Dimensions.paddingSizeSmall),

          CancellationRadioButton(
            isOngoing: rideController.currentRideState == RideState.acceptingRider ? false : true,
