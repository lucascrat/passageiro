...
class _MapScreenState extends State<MapScreen> with WidgetsBindingObserver{
  ...
  String _getAppbarTitle(RideController rideController){
    ...
    }else if(rideController.currentRideState == RideState.acceptingRider || rideController.currentRideState == RideState.otpSent){
  ...
  String? _getAppbarSubTitle(RideController rideController){
    if(rideController.currentRideState == RideState.ongoingRide || rideController.currentRideState == RideState.acceptingRider || rideController.currentRideState == RideState.otpSent){
      return '${rideController.tripDetails?.type == 'parcel' ? 'parcel'.tr : 'trip'.tr} #${rideController.tripDetails?.refId}';
    }else{
      return null;
    }
  }
