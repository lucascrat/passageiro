...
class MapController extends GetxController implements GetxService {
  ...
  void setFromToMarker(LatLng from, LatLng to,{bool isBound = true, required List<LatLng>latLongList}) async{
    markers = HashSet();
    Uint8List fromMarker = await convertAssetToUnit8List(Images.fromIcon, width: 60);
    Uint8List toMarker = await convertAssetToUnit8List(Images.targetLocationIcon, width: 50);
