...
ThemeData lightTheme = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF14B19E))), dialogTheme: DialogThemeData(backgroundColor: const Color(0xFFEEEEEE)),
);
